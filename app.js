...
const PROJECTS = [
  ...
  { name:'MeanreversalRSI', kind:'CRYPTO ALGO', icon:'candle', color:'#9DBEE8', cover:'crypto', repo:'crypto',
    desc:'A distributed crypto mean-reversion & trend-following bot (BTC / ETH / DOGE) — RSI · SuperTrend · Bollinger strategies on Django + Celery + CCXT, with a FastAPI dashboard, MariaDB logging and Telegram alerts.',
    tags:['Django','Celery','CCXT','FastAPI','Telegram'] },
